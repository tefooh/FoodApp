        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.introSection}>
                    <Text style={[styles.mainTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('privacy_policy')}</Text>
                    <Text style={[styles.dateText, { textAlign: isRTL ? 'right' : 'left' }]}>{t('last_updated')}: {t('last_updated_value')}</Text>
                </View>

                <View style={styles.contentCard}>
                    <Section
                        title={t('policy_sec_1_title')}
                        content={t('policy_sec_1_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_2_title')}
                        content={t('policy_sec_2_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_3_title')}
                        content={t('policy_sec_3_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_4_title')}
                        content={t('policy_sec_4_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_5_title')}
                        content={t('policy_sec_5_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_6_title')}
                        content={t('policy_sec_6_content')}
                    />
                    <View style={styles.divider} />
                    <Section
                        title={t('policy_sec_7_title')}
                        content={t('policy_sec_7_content')}
                    />
                </View>
